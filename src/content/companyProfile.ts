...
export const companyIntroduction = {
  ...
  lead:
    "Enikkom Group is an engineering, procurement, fabrication, construction, and installation (EPCI) company, providing project management and support services for onshore and offshore flowlines, pipelines, and facilities. With decades of industry experience, we deliver technical solutions across Nigeria.",
  body: [
    "As a wholly owned subsidiary of Enikkom Investment Services Nigeria Limited (EISNL), established in 1995, Enikkom Group brings together skilled professionals and modern equipment to deliver infrastructure projects nationwide. Our technical depth and track record have made us a trusted partner in Nigeria's oil and gas sector.",
  ],
  subsidiaries: [
    {
    ...
    },
    {
      ...
      paragraphs: [
        "To strengthen its HDD and trenchless technology capacity, ECL partnered with HDDThailand Co. Ltd, an international trenchless specialist with over 15 years of experience. This collaboration gave rise to HDDThailand-Enikkom Limited, an infrastructure company focused on HDD and pipeline construction services.",
        "Through this partnership, the company combines over 22 years of Nigerian HDD experience (via ECL) with HDDThailand's international methods and technology, serving the oil and gas industry.",
      ],
    },
  ],
} as const;
