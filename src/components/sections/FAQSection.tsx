...
const faqs = [
  {
    ...
    answer: "We support a wide range of critical projects including river crossings, road and rail crossings, shore approaches, and swamp pipeline installations. Our capabilities cover continuous HDD, microtunneling, guided boring, and full end-to-end EPCI for pipelines, flowlines, and associated infrastructure.",
  },
  {
    question: "Can you support EPC contractors and energy-sector clients?",
    answer: "Yes. We operate both as a primary contractor for major operators (like SPDC and NNPC) and as a specialist subcontractor for EPC companies. Our team is equipped to integrate seamlessly into larger project frameworks, delivering specialized trenchless and marine civil scopes on schedule.",
  },
  {
    question: "Do you provide project documentation and technical reports?",
    answer: "Absolutely. Engineering precision is at our core. We provide comprehensive project documentation, including pre-drill engineering profiles, execution plans, as-built drawings, and final handover technical reports, ensuring full accountability and compliance with international standards.",
  },
  {
