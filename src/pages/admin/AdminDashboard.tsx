...
// Import admin sub-pages (NEW CMS)
...
const navItems = [
  ...
  { path: '/admin/rfq', label: 'RFQ Submissions', icon: Mail },
];
        ...
        >
          <div className="flex flex-col h-full">
            ...
            <div className="h-16 flex items-center px-6 border-b">
              <span className="font-bold text-xl text-primary">ECL CMS</span>
            </div>
        ...
        <main className="lg:ml-64 pt-16 lg:pt-0 min-h-screen">
          <div className="p-4 lg:p-8">
            <Routes>
              ...
              <Route path="pages/:slug/edit" element={<PageBuilder />} />
